                ...
                <div className="question-list">
                    {questions.length ? questions.map(question => {
                        return (
                            ...
                            >
                                {!question.isAnswered && (
                                    user && (<button type="button" aria-label="Marcar como gostei" className={`like-button ${question.likeId ? 'liked' : ''}`} onClick={() => handleLikeQuestion(question.id, question.likeId)}>
